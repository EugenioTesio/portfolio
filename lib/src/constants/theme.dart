...
final lightTheme =
    FlexThemeData.light(
      ...
      extensions: const <ThemeExtension<dynamic>>[
        HighlightColors(emphasis: Color(0xFFC2410C)),
      ],
    );
...
final dartTheme =
    FlexThemeData.dark(
      ...
      extensions: const <ThemeExtension<dynamic>>[
        HighlightColors(emphasis: Color(0xFFFF8000)),
      ],
    );

/// Bold orange emphasis for experience HTML `<strong>` terms.
@immutable
class HighlightColors extends ThemeExtension<HighlightColors> {
  const HighlightColors({required this.emphasis});

  final Color emphasis;

  @override
  HighlightColors copyWith({Color? emphasis}) {
    return HighlightColors(emphasis: emphasis ?? this.emphasis);
  }

  @override
  HighlightColors lerp(ThemeExtension<HighlightColors>? other, double t) {
    if (other is! HighlightColors) {
      return this;
    }
    return HighlightColors(emphasis: Color.lerp(emphasis, other.emphasis, t)!);
  }
}
